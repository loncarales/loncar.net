...
Everyone has its reasons and motivations for writing a blog. This is my blog, where I'll write for myself, me doing something for me. I often find myself searching for [code snippets](https://gist.github.com/loncarales) I used in the past and then wasting my time and energy to find them again. Putting them someplace safe where I could access them anytime makes perfect sense. I don't expect that vast population will read this. It's for specific people, including me, who will find useful bits and pieces later when needed. Out there are thousands of tutorial posts and how to articles, and I'll try to distance myself for writing similar content.
